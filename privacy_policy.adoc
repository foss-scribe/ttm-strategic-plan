...
It is TTM Policy that anyone who wishes to be removed from our list of subscribers will also have their account terminated and their information purged from our database. Reactivation of the account will not be possible and if the person wishes to rejoin, they must do so as a new member.
