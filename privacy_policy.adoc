...
TTM is bound by the https://www.legislation.gov.au/Series/C2004A03712[_Privacy Act 1988 (Cth)_] (Privacy Act), which sets out a number of principles concerning the privacy of individuals and the obligations laid upon entities who collect personal information.
